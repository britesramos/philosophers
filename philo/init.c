...
/*   Updated: 2024/11/12 10:00:08 by sramos        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static int	init_main_struct(t_table *table)
{
	...
	table->init_m_table_printf = false;
	if (pthread_mutex_init(&table->m_printf, NULL) != 0)
		return (ft_print_error("Creating m_printf failed!"));
	table->init_m_table_printf = true;
